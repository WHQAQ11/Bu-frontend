  ...
  return (
    ...
    >
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        {/* 右半边白色 */}
        <path d="M 50 2 A 48 48 0 0 1 50 98 A 24 24 0 0 1 50 50 A 24 24 0 0 0 50 2" fill="#FFFFFF"/>
...
export const BaGua: React.FC<{
  ...
  return (
    <div className={`${sizeClasses[size]} ${className} flex flex-col justify-between items-center p-1`}>
...
export const Hexagram: React.FC<{
  ...
  return (
    <div className={`${sizeClasses[size]} ${className} flex flex-col justify-between items-center p-1 bg-gray-100 rounded`}>
      {lines.slice().reverse().map((line, index) => (
        <div
          key={index}
...
export const BaguaDiagram: React.FC<TrigramSymbolProps> = ({
  ...
  return (
    <div className={`${sizeClasses[size]} ${className} relative`}>
      <svg viewBox="0 0 100 100" className="w-full h-full">
        {/* 背景圆 - 使用纯白色 */}
        <circle cx="50" cy="50" r="48" fill="#FFFFFF" stroke="#000000" strokeWidth="1"/>
        ...
        <g transform="translate(50, 50)">
          ...
          {/* 左半边黑色 */}
          <path d="M 0 -20 A 20 20 0 0 0 0 20 A 10 10 0 0 0 0 0 A 10 10 0 0 1 0 -20" fill="#000000"/>

          {/* 右半边白色 */}
          <path d="M 0 -20 A 20 20 0 0 1 0 20 A 10 10 0 0 1 0 0 A 10 10 0 0 0 0 -20" fill="#FFFFFF"/>
